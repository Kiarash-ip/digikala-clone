...
export default function Navbar() {
  ...
  const [menoOpenMobile, setMenoOpenMobile] = useState(false);
  ...
  return (
    <>
      <header
        className="lg:fixed relative top-0 left-0 right-0 w-full navbar-boxShadow flex flex-col lg:z-40 z-30 transition-height pt-3 pb-1 px-4 lg:p-0 relative border-b lg:border-0 border-neutral-100 bg-white"
        style={{
          ...(width > 1024 && {
        ...
        <div className="w-full h-full max-w-[1644px] mx-auto flex flex-col relative justify-between">
          <div className="w-full flex lg:flex-row flex-col-reverse items-center lg:px-4 lg:py-3">
            ...
            <div className="flex items-center w-full lg:w-[unset] justify-between lg:p-0 pb-3 lg:border-0 border-b border-neutral-100">
              ...
              <div
                className="lg:hidden cursor-pointer flex items-center justify-center w-[24px] h-[24px]"
                onClick={() => setMenoOpenMobile(true)}
              >
                <FontAwesomeIcon
                  icon={faBars}
          ...
          >
            ...
            <div
              className="lg:flex hidden relative top-0 right-0 flex items-center h-full bg-white"
      ...
      <NavbarMenuMobile menoOpenMobile={menoOpenMobile} />
      <div
        className="fixed w-screen h-screen bg-neutral-900 opacity-75 z-30 top-0 bottom-0"
        style={{ display: menuOpen || menoOpenMobile ? "block" : "none" }}
        onClick={() => setMenoOpenMobile(false)}
      ></div>
    </>
  );
}
